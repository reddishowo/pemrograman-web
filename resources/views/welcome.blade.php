...
<body class="bg-gray-100">
    ...
    <header class="bg-white shadow-md sticky top-0 z-50">
        <nav class="container mx-auto flex justify-between items-center p-5">
            ...
            <ul id="menu" class="hidden lg:flex space-x-8 text-gray-700 font-medium">
                ...
                <li><a href="services.html" class="hover:text-gray-900">Services</a></li>
                <li><a href="product.html" class="hover:text-gray-900">Product</a></li>
        ...
        <div id="mobileMenu" class="lg:hidden hidden bg-white shadow-md">
            <ul class="text-gray-700 font-medium space-y-2 p-5">
                ...
                <li><a href="about.html" class="block hover:text-gray-900">About</a></li>
    ...
    <section class="flex flex-col items-center text-center h-[75vh] space-y-6">
        ...
        <div class="w-full max-w-xl">
            ...
            <a href="#relaxed-elegance" class="bg-yellow-500 hover:bg-yellow-600 text-white py-2 px-6 rounded-lg">Read
                more</a>
        </div>
    </section>
    ...
    <section class="py-16">
        <div class="container mx-auto">
            <div class="flex justify-between items-center mb-8">
                <h1 class="text-4xl font-semibold" data-aos="fade-right" data-aos-delay="300" data-aos-duration="1000">
                    Bestsellers</h1>
                <a href="#" class="text-yellow-500 font-medium hover:text-yellow-600" data-aos="fade-left"
                    data-aos-delay="300" data-aos-duration="1000">See all</a>
            </div>
    ...
    <footer class="bg-gray-800 text-gray-400 py-12">
        <div class="container mx-auto text-center">
            ...
            <p>&copy; 2024 Tailor. All rights reserved.</p>
        </div>
    </footer>
